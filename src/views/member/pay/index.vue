<template>
    <div class="xtx-pay-page">
      <div class="container">
        ...
        <div class="pay-type">
          ...
          <div class="item">
            ...
            <a :href="payUrl" @click="visibleDialog=true" class="btn alipay" target="_blank"></a>
          </div>
          <div class="item">
            <p>支付方式</p>
      ...
      <div class="pay-wait">
        ...
        <div v-if="order">
            <p>如果支付成功：</p>
            <RouterLink :to="`/member/result/${order.id}`">查看订单详情></RouterLink>
            <p>如果支付失败：</p>
...
import { baseURL } from '@/utils/request'
  export default {
    ...
    setup () {
        ...
        return {
            order, timeText, payUrl, visibleDialog
        }
    }
  }
  </script>
